...
#define PDU_TM_PORT   17
#define PDU_ADDRESS	  11
#define ADCSCOMP_TC_PORT 8
#define ADCSCOMP_ADDRESS 4
#define numRcvCAN1Task 4

extern osThreadId_t RcvCSPHandle[numRcvCAN1Task];
extern osThreadAttr_t RcvCSPHandle_attributes;
extern osThreadAttr_t DummyHandle_attributes;
/**
   CSP configuration.
   @see csp_init()
*/
